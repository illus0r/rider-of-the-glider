    ...
    loadShader(shader) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const pass of passes) {
                ...
                newRenderPasses.push(yield this.createRenderPass(pass));
            }
    ...
    loadTexture(name, textureUrl, speed = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isVideo(textureUrl)) {
                ...
                texture = yield this.gifLoader.load(name, textureUrl);
                ...
                texture = yield new Promise((resolve, reject) => this.textureLoader.load(textureUrl, resolve, undefined, reject));
